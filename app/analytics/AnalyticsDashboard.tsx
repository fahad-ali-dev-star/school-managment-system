...
export default function AnalyticsDashboard({ data, schoolName }: Props) {
  ...
  const kpiCards = [
    ...
    { label: 'Prev Months Outstanding', value: `Rs ${kpis.totalPending.toLocaleString()}`,   color: '#d97706', icon: '⏳', bg: '#fffbeb' },
      ...
      <div style={cardStyle}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: '1rem' }}>
          {[
            ...
            { label: 'Prev Months Outstanding',    value: `Rs ${kpis.totalPending.toLocaleString()}`,             icon: '⏳' },
